                ...
                <ul class="navbar-nav navbar-align">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                            ...
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="<%=request.getContextPath()%>/img/avatars/avatar-5.jpg" class="avatar img-fluid rounded-circle"
                                                 alt="Vanessa Tucker">
                                        </div>
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="<%=request.getContextPath()%>/img/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle"
                                                 alt="William Harris">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="<%=request.getContextPath()%>/img/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle"
                                                 alt="Christina Mason">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="<%=request.getContextPath()%>/img/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle"
                                                 alt="Sharon Lessman">
                                        </div>
                                        <div class="col-10 ps-2">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="<%=request.getContextPath()%>/img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall"/>
                            ...
                            <div class="container-fluid">
                                <a class="navbar-brand" href="#">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                            data-bs-target="#newSizeModal">+ Add new Size
                                    </button>
                                </a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="newSizeLabel">Create new size</h5>
                                                ...
                                                <div class="modal-body">
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"
                                                              id="basic-addon1">Tên Size</span>
                                                        <input type="text" class="form-control"
                                                               placeholder="Nhập tên danh mục"
                                                               aria-label="sizeName" aria-describedby="basic-addon1"
                                                               name="sizeName">
                                                    </div>
                                                    <div class="input-group mb-3">
                                                    <span class="input-group-text"
                                                          id="sizeStatus">Trạng thái danh mục</span>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="sizeStatus"
                                                               id="sizeStatus1" value="true">
                                                        <label class="form-check-label" for="sizeStatus1">Hoạt
                                                            động</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="sizeStatus"
                                                               id="sizeStatus2" value="false">
                                                        <label class="form-check-label" for="sizeStatus2">Không hoạt
                                                            động</label>
                                                    </div>
                                                </div>
                                ...
                                <%--                                end create new cat --%>
                                <form class="d-flex" role="search" action="<%=request.getContextPath()%>/SizeServlet">
                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listSize}" var="size">
                                <tr>
                                    <td>${size.sizeId}</td>
                                    <td>${size.sizeName}</td>
                                    <td>${size.sizeStatus?"Hoạt động":"Không hoạt động"}</td>
                                    <td>
                                        <input type="hidden" id="catDeleteId" value="${size.sizeId}">

                                            <%--                                        <a type="button" href="#updateCatalogModal" class="update" data-bs-toggle="modal"></a>--%>
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#updateCatalogModal" data-bs-whatever="${size.sizeId}" id="updateCat">Update
                                        </button>
