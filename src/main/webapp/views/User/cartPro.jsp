            ...
            <div class="col-lg-12">
                <div class="shop__cart__table">
                    <table>
                        ...
                        <tr>
                            <td class="cart__product__item">
                                <img src="<%=request.getContextPath()%>/img/shop-cart/cp-2.jpg" alt="">
                                <div class="cart__product__item__title">
                        ...
                        <tr>
                            <td class="cart__product__item">
                                <img src="<%=request.getContextPath()%>/img/shop-cart/cp-3.jpg" alt="">
                                <div class="cart__product__item__title">
                                    <h6>Black jean</h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
                        ...
                        <tr>
                            <td class="cart__product__item">
                                <img src="<%=request.getContextPath()%>/img/shop-cart/cp-4.jpg" alt="">
                                <div class="cart__product__item__title">
                                    <h6>Cotton Shirt</h6>
                                    <div class="rating">
                                        <i class="fa fa-star"></i>
