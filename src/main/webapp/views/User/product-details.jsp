                    ...
                    <div class="aa-header-top-area">
                        ...
                        <div class="aa-header-top-right">
                            <ul class="aa-head-top-nav-right">
                                <li><a href="<%=request.getContextPath()%>/views/User/account.jsp">My Account</a></li>
                                <li class="hidden-xs"><a href="<%=request.getContextPath()%>/views/User/wishlist.jsp">Wishlist</a></li>
                                <li class="hidden-xs"><a href="<%=request.getContextPath()%>/views/User/cart.jsp">My Cart</a></li>
                    ...
                    <div class="aa-header-bottom-area">
                        ...
                        <div class="aa-cartbox">
                            ...
                            <div class="aa-cartbox-summary">
                                <ul>
                                    <li>
                                        <a class="aa-cartbox-img" href="#"><img src="<%=request.getContextPath()%>/img/woman-small-2.jpg" alt="img"></a>
                                    ...
                                    <li>
                                        <a class="aa-cartbox-img" href="#"><img src="<%=request.getContextPath()%>/img/woman-small-1.jpg" alt="img"></a>
                                        <div class="aa-cartbox-info">
                                            <h4><a href="#">Product Name</a></h4>
                                            <p>1 x $250</p>
                                        </div>
            ...
            <div class="navbar navbar-default" role="navigation">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<%=request.getContextPath()%>/views/Admin/contact.html">Contact</a></li>
                ...
                <div class="aa-product-details-area">
                                ...
                                <div class="aa-product-view-slider">
                                    <div id="demo-1" class="simpleLens-gallery-container">
                                        <div class="simpleLens-container">
                                            <div class="simpleLens-big-image-container"><a data-lens-image="<%=request.getContextPath()%>/img/view-slider/large/polo-shirt-1.png" class="simpleLens-lens-image"><img src="<%=request.getContextPath()%>/img/view-slider/medium/polo-shirt-1.png" class="simpleLens-big-image"></a></div>
                                        </div>
                                        <div class="simpleLens-thumbnails-container">
                                            <a data-big-image="img/view-slider/medium/polo-shirt-1.png" data-lens-image="<%=request.getContextPath()%>/img/view-slider/large/polo-shirt-1.png" class="simpleLens-thumbnail-wrapper" href="#">
                                                <img src="<%=request.getContextPath()%>/img/view-slider/thumbnail/polo-shirt-1.png">
                                            </a>
                                            <a data-big-image="img/view-slider/medium/polo-shirt-3.png" data-lens-image="<%=request.getContextPath()%>/img/view-slider/large/polo-shirt-3.png" class="simpleLens-thumbnail-wrapper" href="#">
                                                <img src="<%=request.getContextPath()%>/img/view-slider/thumbnail/polo-shirt-3.png">
                                            </a>
                                            <a data-big-image="img/view-slider/medium/polo-shirt-4.png" data-lens-image="<%=request.getContextPath()%>/img/view-slider/large/polo-shirt-4.png" class="simpleLens-thumbnail-wrapper" href="#">
                    ...
                    <div class="aa-product-related-item">
                        ...
                        <ul class="aa-product-catg aa-related-item-slider">
                            ...
                            <li>
                                <figure>
                                    <a class="aa-product-img" href="#"><img src="<%=request.getContextPath()%>/img/women/girl-2.png" alt="polo shirt img"></a>
                                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                    <figcaption>
                            ...
                            <li>
                                <figure>
                                    <a class="aa-product-img" href="#"><img src="<%=request.getContextPath()%>/img/man/t-shirt-1.png" alt="polo shirt img"></a>
                                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                </figure>
                                <figcaption>
                            ...
                            <li>
                                <figure>
                                    <a class="aa-product-img" href="#"><img src="<%=request.getContextPath()%>/img/women/girl-3.png" alt="polo shirt img"></a>
                                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                    <figcaption>
                                        <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                        <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                            ...
                            <li>
                                <figure>
                                    <a class="aa-product-img" href="#"><img src="<%=request.getContextPath()%>/img/man/polo-shirt-1.png" alt="polo shirt img"></a>
                                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                    <figcaption>
                                        <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                        <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                            ...
                            <li>
                                <figure>
                                    <a class="aa-product-img" href="#"><img src="<%=request.getContextPath()%>/img/women/girl-4.png" alt="polo shirt img"></a>
                                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                    <figcaption>
                                        <h4 class="aa-product-title"><a href="#">Lorem ipsum doller</a></h4>
                                        <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                            ...
                            <li>
                                <figure>
                                    <a class="aa-product-img" href="#"><img src="<%=request.getContextPath()%>/img/man/polo-shirt-4.png" alt="polo shirt img"></a>
                                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                    <figcaption>
                                        <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                                        <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                            ...
                            <li>
                                <figure>
                                    <a class="aa-product-img" href="#"><img src="<%=request.getContextPath()%>/img/women/girl-1.png" alt="polo shirt img"></a>
                                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                                    <figcaption>
                                                        ...
                                                        <div class="simpleLens-container">
                                                            <div class="simpleLens-big-image-container">
                                                                <a class="simpleLens-lens-image" data-lens-image="img/view-slider/large/polo-shirt-1.png">
                                                                    <img src="<%=request.getContextPath()%>/img/view-slider/medium/polo-shirt-1.png" class="simpleLens-big-image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div class="simpleLens-thumbnails-container">
            ...
            <div class="modal-body">
                ...
                <form class="aa-login-form" action="">
                    ...
                    <div class="aa-register-now">
                        Don't have an account?<a href="<%=request.getContextPath()%>/views/User/account.jsp">Register now!</a>
                    </div>
                </form>
            </div>
        </div><!-- /.modal-content -->
